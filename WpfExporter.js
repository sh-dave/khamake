...
class WpfExporter extends CSharpExporter {
	...
	exportResources() {
		...
		this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "AssemblyInfo.cs")));
		...
		this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "Resources.Designer.cs")));
		...
		this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "Resources.resx")).toString());
		...
		this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "Settings.Designer.cs")).toString());
		this.p("namespace WpfApplication1.Properties");
		this.p("{");
		this.p("[global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]", 1);
		...
		this.writeFile(this.directory.resolve(Paths.get(this.sysdir() + "-build", "Properties", "Settings.settings")).toString());
		this.p("<?xml version='1.0' encoding='utf-8'?>");
